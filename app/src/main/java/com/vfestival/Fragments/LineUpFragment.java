...
public class LineUpFragment extends Fragment {
    ...
    private void prepareMovieData() {
        Artists artist = new Artists("Jay Z", R.drawable.jay_z ,"https://www.facebook.com/JayZ/", "https://twitter.com/JAY_Z_Daily?lang=en", "http://lifeandtimes.com/","Born Shawn Corey Carter in New York City on December 4, 1969, Jay-Z grew up in Brooklyn's drug-infested Marcy Projects. He used rap as an escape, appearing for the first time on Yo! MTV Raps in 1989. After selling millions of records with his Roc-a-Fella label,");
        ...
        artist = new Artists("Bastille",  R.drawable.bastille, "https://www.facebook.com/bastilleuk/", "https://twitter.com/bastilledan?lang=en", "http://www.bastillebastille.com/","Bastille (stylised as BΔSTILLE) are a British rock band formed in 2010. The group began as a solo project by lead vocalist Dan Smith, but later expanded to include keyboardist Kyle Simmons, bassist and guitarist Will Farquarson, and drummer Chris Wood.[1] The name of the band derives from Bastille Day, which is celebrated on 14 July, the date of Smith's birthday.");
        artistsList.add(artist);
